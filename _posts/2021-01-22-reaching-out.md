---
layout: post
title: "2021-01-22: Reaching the IAC Team"
author: pmcmaw
categories:
  - team
tags:
  ...
  - communication
---
![hello]({% link /assets/2021-01-22-reaching-out/hello.png %}){:height="170px" width="170px"}
...
## Monday is Community Day ![slack]({% link /assets/2021-01-22-reaching-out/calendar.png %}){:height="30px" width="30px"}
...
## Reaching out via Slack ![slack]({% link /assets/2021-01-22-reaching-out/slack.png %}){:height="45px" width="45px"}
...
**Use the ![sos]({% link /assets/2021-01-22-reaching-out/sos.gif %}){:height="50px" width="50px"}
 emoji on urgent issues that require the attention of a puppet employee.**

## Reaching out via Jira ![bug]({% link /assets/2021-01-22-reaching-out/bug.png %}){:height="40px" width="40px"}
...
## Some things just can't wait ![clock]({% link /assets/2021-01-22-reaching-out/clock.png %}){:height="40px" width="40px"}
...
## Useful Tips ![magic]({% link /assets/2021-01-22-reaching-out/magic.png %}){:height="40px" width="40px"}
